<div id="exampleCode" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleCodeLabel" aria-hidden="true">
    <div class="modal-dialog" style="width: 700px;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="exampleCodeLabel"><?php echo __('Example Code', 'news');?></h4>
            </div>
