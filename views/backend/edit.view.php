...
<div class="row">
    <div class="col-md-6">
        <?php
        echo (
            Form::submit('edit_news_and_exit', __('Save and exit', 'news'), array('class' => 'btn btn-primary')).Html::nbsp(2).
            Form::submit('edit_news', __('Save', 'news'), array('class' => 'btn btn-primary')).Html::nbsp(2).
